...
class ClienteModelForm(forms.ModelForm):
    class Meta:
        model = Cliente
        fields = ['nome', 'telefone', 'foto', 'email', 'tipoCliente']
        #fields = '__all__'

        error_messages = {
            'nome': {'required': 'O nome do fornecedor é um campo obrigatório'},
            'telefone': {'required': 'O endereco do fornecedor é um campo obrigatório'},
            'foto': {'required': 'O número do telefone é um campo obrigatório'},
